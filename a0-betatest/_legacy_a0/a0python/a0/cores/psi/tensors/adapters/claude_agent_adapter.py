...
class ClaudeAgentAdapter:
    ...
    def __init__(self, mode: str = "analyze", cwd: str | None = None, max_turns: int = 20) -> None:
        self._mode = mode
        self._cwd = cwd
    ...
    def complete(self, messages: List[Message], **kwargs: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "text": f"[ClaudeAgentAdapter] error: {e}",
                "raw": {},
                "subagents_used": [],
            }

    async def _run_async(self, prompt: str, subagents: Dict[str, Any], mode: str) -> Dict[str, Any]:
        result_text = ""
